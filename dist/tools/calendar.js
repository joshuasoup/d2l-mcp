...
export const calendarTools = {
    get_upcoming_due_dates: {
        ...
        handler: async (args) => {
            ...
            const events = await client.getMyCalendarEvents(orgUnitId, startDate.toISOString(), endDate.toISOString());
